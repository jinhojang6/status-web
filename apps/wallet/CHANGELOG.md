...
- 5c5585a: add wallet page listeners
- 8467e46: Add value chart
- 57ac324: listen to wallet uninstall
- c51e8b4: fix refetch
...
- 28715e8: update wxt config
- 8467e46: Persistent recovery phrase
- 8467e46: Rename tabs
- 4500418: add build steps
...
- ddd9dfe: fix recovery phrase backup
- f843f87: fix failing api calls due to inactive service worker
- c7a6e71: fix collectibles
- 997b4a1: remote config env
- 5947450: use env mode
